...
<body>
    ...
    <div class="titulo">
        <h1>Controle de <span>Usuários<span></h1>
    </div>
<div class="container">
    <a class="button-group" href="./CadastrarUsuarios.php">
    ...
    <a class="button-group"  href="./ConsultarUsuarios.php">
...
<div class="logoindex">
    <img src="../public/img/consultarUsuario.svg" alt="logo index" id="ilustracao">  
</div>
