...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&display=swap" rel="stylesheet">    
    <title>Controle de Editoras</title>
</head>
<body>

   
    <div class="titulo">
        <h1>Controle de <span>Editoras<span></h1>
    </div>
<div class="container">
    <a class="button-group" href="./CadastrarEditoras.php">
    ...
    <a class="button-group"  href="./ConsultarEditoras.php">
...
<div class="logoindex">
    <img src="../public/img/controleEditoras.svg" alt="logo index" id="ilustracao">  
</div>
