...
<body>
    ...
    <div class="titulo">
        <h1>Controle de <span>Livros<span></h1>
    </div>
<div class="container">
    <a class="button-group" href="./CadastrarLivros.php">
        <button class="btn-green"><img src="../public/img/adicionarLivro.png" alt="Cadastrar"></button>
        <button class="btn-white">Cadastrar</button>
    </a>

    <a class="button-group"  href="./ConsultarLivros.php">
...
<div class="logoindex">
    <img src="../public/img/controleDeLivros.svg" alt="logo index" id="ilustracao">  
</div>
