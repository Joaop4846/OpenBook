...
<body>
    ...
    <div class="titulo">
        <h1>Controle de <span>Empréstimos<span></h1>
    </div>
<div class="container">
    <a class="button-group" href="./CadastrarEmprestimos.php">
    ...
    <a class="button-group"  href="./ConsultarEmprestimos.php">
...
<div class="logoindex">
    <img src="../public/img/controleEmprestimo.svg" alt="logo index" id="ilustracao">  
</div>
